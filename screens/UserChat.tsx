...
import { View, Text, SafeAreaView, StatusBar, StyleSheet, Pressable, FlatList, Modal, ScrollView } from 'react-native';
import * as Font from 'expo-font';
import Ionicons from '@expo/vector-icons/Ionicons';
import chatData from '../assets/data/dummyChats.json'; // Adjust the path as needed
import { Chat } from '../assets/data/types'; // Adjust the path as needed
                        ...
                        <ScrollView style={styles.modalScroll}>
                            {selectedChat && (
                                <View>
                                    ...
                                    <Text style={styles.modalChatMessage}>Hello, I am your event planner. How can I assist you?</Text>
                                    <Text style={styles.modalChatMessage}>{selectedChat.lastMessage}</Text>
