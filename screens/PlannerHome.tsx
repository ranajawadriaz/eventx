...
const PlannerHome = () => {
    ...
    const recentFeedback = [
        { id: '1', description: 'Excellent venue for the last event!', date: '2024-08-20' },
        { id: '2', description: 'Great organization, but could improve on the catering.', date: '2024-08-18' },
    ];

    const plannerStats = [
        { id: '1', label: 'Events Organized', value: '12' },
        { id: '2', label: 'Teams Managed', value: '5' },
        { id: '3', label: 'Client Satisfaction', value: '85%' },
        { id: '4', label: 'Average Rating', value: '4.7' },
    ];
        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.scrollViewContent}>
                <View style={styles.innerContainer}>
                    ...
                    <View style={styles.sectionContainer}>
                        ...
                        {recentFeedback.map((feedback) => (
                            <View key={feedback.id} style={styles.itemContainer}>
                                <Text style={styles.itemText}>{feedback.description}</Text>
                                <Text style={styles.itemSubText}>{feedback.date}</Text>
                            </View>
                        ))}
                    </View>
                    ...
                    {/* Planner Stats */}
                    <View style={styles.sectionContainer}>
                        <Text style={styles.sectionTitle}>Planner Stats</Text>
