...
const PlannerProfile = () => {
  ...
  // Dummy data for the planner organization profile
  const profileData = {
    name: "Event Planning Corp.",
    contactEmail: "contact@eventplanningcorp.com",
    bio: "We are a professional event planning organization specializing in corporate and personal events. Your trusted partner for seamless event management.",
  };

  // Dummy data for profile details
  const profileDetails: ProfileDetail[] = [
    { id: '1', title: 'Address', detail: '456 Corporate Ave, Suite 100, Metropolis' },
    { id: '2', title: 'Phone', detail: '+9876543210' },
    { id: '3', title: 'Website', detail: 'www.eventplanningcorp.com' },
    { id: '4', title: 'Business Hours', detail: 'Mon-Fri: 9 AM - 6 PM' },
    { id: '5', title: 'Specialties', detail: 'Corporate Events, Weddings, Conferences' },
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        ...
        <View style={styles.profileContainer}>
          ...
          <Text style={styles.profileEmail}>{profileData.contactEmail}</Text>
        ...
        >
          <View style={styles.modalContainer}>
            <View style={styles.modalContent}>
              ...
              <Text style={styles.modalDetail}>Are you sure you want to delete this profile?</Text>
